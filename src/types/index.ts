...
export type CallbackWithArgs<TArgs extends any[] = [], TReturn = void> = (...args: TArgs) => TReturn;
export type AsyncCallbackWithArgs<TArgs extends any[] = [], TReturn = void> = (...args: TArgs) => Promise<TReturn>;