...
describe('Security Tests', () => {
  ...
  describe('Input Validation', () => {
    ...
    it('should sanitize HTML in workout descriptions', () => {
      const maliciousDescription =
        'This is a <img src="x" onerror="alert(1)"> workout';
  ...
  describe('XML Security', () => {
    it('should prevent XXE (XML External Entity) attacks', () => {
      ...
      expect(() => parseSecureXML(xxeXml)).toThrow(
    ...
    it('should prevent XML bomb attacks', () => {
      ...
      expect(() => parseSecureXML(bombXml)).toThrow(
        'Malformed or suspicious XML'
      );
    });
  ...
  describe('Data Protection', () => {
    it('should not expose sensitive information in errors', () => {
      const error = createSafeErrorMessage(
    ...
    it('should sanitize database queries', () => {
      ...
      const query = buildSafeQuery('SELECT * FROM workouts WHERE name = ?', [
        userInput,
      ]);
...
function isSecureUrl(url) {
  ...
  return !blockedProtocols.some(protocol =>
