...
test.describe('Workout Upload Flow', () => {
  ...
  test('should upload and display workout file', async ({ page }) => {
    ...
    const workoutDuration = await page
      .locator('.workout-duration')
      .textContent();
...
test.describe('Export Functionality', () => {
  ...
  test('should export workout as image', async ({ page }) => {
    ...
    const exportBtn = page
      .locator('button')
      .filter({ hasText: /export|download|save/i })
      .first();
  ...
  test('should support multiple export formats', async ({ page }) => {
    ...
    const formatSelector = page.locator(
      'select[name="export-format"], .export-format'
    );
