...
describe('Performance Tests', () => {
    ...
    describe('Parsing Performance', () => {
        ...
        it('should handle large workouts efficiently', async () => {
            ...
            const parseWorkoutXML = vi.fn().mockReturnValue(createMockWorkout({
                totalDuration: 7200,
                segments: new Array(720).fill({ type: 'SteadyState', duration: 10, power: 0.8 })
            }));
            parseWorkoutXML(xmlDoc);
    ...
    describe('Chart Rendering Performance', () => {
        it('should render charts quickly', () => {
            ...
            mockChart.data.datasets = [{
                data: workout.segments.map(seg => ({ x: seg.startTime, y: seg.power }))
            }];
            mockChart.update();
        ...
        it('should handle data point limits for performance', () => {
            ...
            const reducedData = reduceDataForPerformance(highResWorkout.segments, 1000);
    ...
    describe('Memory Management', () => {
        ...
        it('should efficiently handle large datasets', () => {
            const largeWorkout = createMockWorkout({
                segments: new Array(50000).fill({ type: 'SteadyState', duration: 1, power: 0.8 })
            });
    ...
    describe('Calculation Performance', () => {
        it('should calculate TSS efficiently', () => {
            const workout = createMockWorkout({
                segments: new Array(1000).fill({ type: 'SteadyState', duration: 10, power: 0.8 })
            });
        ...
        it('should generate power data efficiently', () => {
            ...
            const generatePowerData = vi.fn().mockReturnValue(
    ...
    describe('Search Performance', () => {
        it('should search workouts quickly', async () => {
            ...
            const searchWorkouts = vi.fn().mockReturnValue(
        ...
        it('should filter by tags efficiently', () => {
            ...
            // Mock tag filtering
            const filterByTags = vi.fn().mockReturnValue(
                workouts.filter(w => w.tags.includes('tag-1'))
            );
