...
import { ErrorLogger, logFileUploadError, logParsingError } from '../../error-logger.js';
...
describe('ErrorLogger', () => {
    ...
    describe('Warning and Info Logging', () => {
        it('should log warnings correctly', () => {
            const logId = errorLogger.logWarning('Test warning', { component: 'uploader' });
    ...
    describe('Log Retrieval and Statistics', () => {
        ...
        it('should clear all logs', () => {
            ...
            expect(localStorage.removeItem).toHaveBeenCalledWith('workoutLibrary_logs');
        });
    });
