...
describe.skip('WorkoutStorage', () => {
  ...
  describe('Database initialization', () => {
    it('should initialize database successfully', async () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(
        'WorkoutLibrary database initialized successfully'
      );
    ...
    it('should handle upgrade needed event', async () => {
      const createStoresSpy = vi
        .spyOn(storage, 'createObjectStores')
        .mockImplementation(() => {});
  ...
  describe('Database operations', () => {
    ...
    it('should handle database transaction errors', async () => {
      ...
      await expect(storage.saveWorkout(workout)).rejects.toThrow(
        'Transaction failed'
      );
    });
  });
  ...
  describe('Error handling', () => {
    it('should handle database connection failures gracefully', async () => {
      ...
      await expect(storage.initialize()).rejects.toThrow(
        'Failed to open database: Connection failed'
      );
    });
    ...
    it('should handle quota exceeded errors', async () => {
      ...
      await expect(storage.saveWorkout(largeWorkout)).rejects.toThrow(
        'QuotaExceededError'
      );
    });
  });
