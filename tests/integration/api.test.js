...
import {
  sampleWorkouts,
  mockApiResponses,
} from '../fixtures/sample-workouts.js';
...
describe('API Integration Tests', () => {
  ...
  describe('Workout Upload API', () => {
    it('should upload workout file successfully', async () => {
      ...
      formData.append(
        'workout',
        createMockFile(sampleWorkouts.simple, 'test.zwo')
      );
    ...
    it('should validate file types', async () => {
      ...
      formData.append(
        'workout',
        createMockFile('not xml', 'test.txt', 'text/plain')
      );
  ...
  describe('Content Security', () => {
    it('should sanitize uploaded workout content', async () => {
      ...
      expect(result.warnings).toContain(
        'Script tags removed from workout name'
      );
    });
