...
export class StateManager {
    ...
    dispatch(action, payload = {}) {
        const actionHandlers = {
            ...
            'LOAD_WORKOUT': (workoutData) => {
                ...
                this.setState('originalWorkout', JSON.parse(JSON.stringify(workoutData)));
            ...
            'UPDATE_WORKOUT': (workoutData) => {
                ...
                if (currentWorkout) {
                    this.setState('undoStack', [...this.getState('undoStack'), currentWorkout]);
                    this.setState('redoStack', []);
                }
                this.setState('workout', workoutData);
            },
            ...
            'UNDO_WORKOUT': () => {
                ...
                if (undoStack.length > 0) {
                    ...
                    this.setState('redoStack', [...this.getState('redoStack'), currentWorkout]);
    ...
    setupPerformanceMonitoring() {
            ...
            this.performanceObserver = new PerformanceObserver((list) => {
                ...
                for (const entry of entries) {
                    if (entry.entryType === 'navigation') {
                        this.setState('performanceMetrics.loadTime', entry.loadEventEnd - entry.loadEventStart);
        ...
        if ('memory' in performance) {
            setInterval(() => {
                this.setState('performanceMetrics.memoryUsage', performance.memory.usedJSHeapSize);
            }, 10000);
        }
    }
    ...
    savePreferences() {
        try {
            ...
            localStorage.setItem('workout-visualizer-preferences', JSON.stringify(preferences));
        } catch (error) {
