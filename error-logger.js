...
export class ErrorLogger {
    ...
    getUserFriendlyMessage(error, context) {
        ...
        const friendlyMessages = {
            'file-upload': 'There was a problem uploading your workout file. Please check the file format and try again.',
            'parsing': 'Your workout file could not be read. Please ensure it\'s a valid .zwo file.',
            'network': 'Connection problem. Please check your internet connection and try again.',
            'storage': 'Unable to save your workout. Your browser storage might be full.',
            'chart-render': 'There was a problem displaying the workout chart. Try refreshing the page.',
            'uncaught-error': 'An unexpected error occurred. The page will continue to work, but some features might be affected.',
            'unhandled-rejection': 'A background operation failed. Your work has been saved, but please refresh the page.'
        };
