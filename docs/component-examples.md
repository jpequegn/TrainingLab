...
<div class="flex space-x-4">
  ...
  <button class="btn-modern">Publish</button>
  <!-- Use btn-outline instead -->
</div>
...
<button
  class="btn-outline border border-input bg-background hover:bg-accent hover:text-accent-foreground"
>
  Try Sample
</button>
...
```html
<!-- Loading state -->
<button class="btn-modern btn-loading" disabled>Loading...</button>

<!-- Disabled state -->
<button class="btn-modern" disabled>Disabled Action</button>
```
...
<div class="card-modern p-2 pt-6 pb-8">
  <!-- Avoid mixed padding values -->
...
<section class="relative py-12 px-4">
  <div class="container relative mx-auto text-center">
    <div
      class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-primary to-primary/80 rounded-2xl mb-6"
    >
    ...
    <p class="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
      Transform your Zwift workout files into stunning interactive
      visualizations
    </p>
...
<div
  class="card-modern p-4 transition-all duration-150 hover:transform hover:-translate-y-1"
>
...
<div
  class="card-modern p-4 transition-all duration-500 hover:scale-110 hover:rotate-3"
>
  <h3>Distracting Animation</h3>
  <!-- Too much movement -->
</div>
```
...
<button
  class="btn-modern focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
>
  Accessible Button
</button>
...
<a
  href="#main-content"
  class="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 bg-primary text-primary-foreground px-3 py-2 rounded"
>
...
<button class="btn-modern rounded-full">
  <!-- Conflicts with angular design -->
  Mixed Styles
</button>
...
<div class="p-3 m-7 space-y-5">
  <!-- Doesn't follow 8px grid -->
  Random Spacing
</div>
