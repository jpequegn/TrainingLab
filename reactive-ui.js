...
export class ReactiveUI {
    ...
    bind(selector, statePath, options = {}) {
        ...
        const unsubscribe = stateManager.subscribe(statePath, (newValue, oldValue) => {
    ...
    bindList(containerSelector, statePath, templateFn, options = {}) {
        ...
        const unsubscribe = stateManager.subscribe(statePath, (items) => {
            this.renderList(container, items, templateFn, keyProperty, emptyMessage);
        }, { immediate: true });
    ...
    setupBindings() {
        ...
        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', () => this.initializeBindings());
        } else {
    ...
    initializeBindings() {
        ...
        stateManager.subscribe('activePanel', (activePanel) => {
            ...
            const activePanelEl = document.querySelector(`[data-panel="${activePanel}"]`);
            if (activePanelEl) {
